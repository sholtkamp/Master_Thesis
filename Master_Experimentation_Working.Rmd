...
#createSubsets("E:/Master_Daten/data/Layers_cropped/RED_EDGE_train.tif", c(128, 128), TRUE, "E:/Master_Daten/data/Tiles/RED_EDGE/train/", ".tif")
...
switch(Sys.info()[['sysname']],
       ...
       Windows= {
         ...
         # read input
         train_data <- readInput("E:/Master_Daten/testing/train/", c(128, 128), ".tif")
         mask_data <- readInput("E:/Master_Daten/testing/masks/", c(128, 128), ".tif")
         test_data <- readInput("E:/Master_Daten/testing/test/", c(128, 128), ".tif")
         
         # flatten layers
         #train_data_flat <- array_reshape(train_data, c(nrow(train_data), 128*128))
         #mask_data_flat <- array_reshape(mask_data, c(nrow(mask_data), 128*128))
         #test_data_flat <- array_reshape(test_data, c(nrow(test_data), 128*128))
         
         
         #Laptop
         # train_data <- readInput("C:/Masterarbeit/testing/train/", c(128, 128), ".tif")
         # train_data <- train_data / 255
         # train_data_flat <- array_reshape(train_data, c(nrow(train_data), 128*128))
         # 
         # mask_data <- readInput("C:/Masterarbeit/testing/masks/", c(128, 128), ".tif")
         # mask_data_flat <- array_reshape(mask_data, c(nrow(mask_data), 128*128))
         # 
         # test_data <- readInput("C:/Masterarbeit/testing/test/", c(128, 128), ".tif")
       ...
       Linux  = {
         ...
         train_data <- readInput("/home/basti/Desktop/testing/train/", c(128, 128), ".tif")
         mask_data <- readInput("/home/basti/Desktop/testing/masks/", c(128, 128), ".tif")
         test_data <- readInput("/home/basti/Desktop/testing/test/", c(128, 128), ".tif")
