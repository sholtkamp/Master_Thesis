...
read_data <- function(dimensions = c(128, 128), channels = 6){
  ...
  read_data <- list("tile_data" = tile_data, "mask_data" = mask_data, "target_data" = target_data)
...
balance_data <- function(paradigm = "pixel", data, aim){
 ...
 cat("\nBalancing data\n")
  ...
  # make list of arrays to return
  balanced_data <- list("tile_data" = tile_data, "mask_data" = mask_data, "target_data" = target_data)
...
#unet_model <- build_unet_model(input_shape = c(128, 128, 3), num_classes = 2)
